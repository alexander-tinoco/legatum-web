...
export async function GET() {
  ...
  const pages = [
    ...
    { url: `${site.url}/herramientas/que-visa-necesito/`, lastmod: now, changefreq: 'monthly', priority: '0.7' },
    { url: `${site.url}/herramientas/checklist-arraigo/`, lastmod: now, changefreq: 'monthly', priority: '0.6' },
    { url: `${site.url}/herramientas/`, lastmod: now, changefreq: 'monthly', priority: '0.7' },
    { url: `${site.url}/herramientas/calculadora-costos/`, lastmod: now, changefreq: 'monthly', priority: '0.6' },
    { url: `${site.url}/herramientas/simulador-visa/`, lastmod: now, changefreq: 'monthly', priority: '0.6' },
